                ...
                <div id="header-wp">
                    <div class="wp-inner clearfix">
                        ...
                        <ul id="main-menu" class="fl-left">
                            <li>
                                <a href="?blog=list_post" title="">Trang</a>
                                <ul class="sub-menu">
                                    <li>
                                        <a href="?mod=blog&action=add_page" title="">Thêm mới</a> 
                                    </li>
                                    <li>
                                        <a href="?mod=blog&action=list_page" title="">Danh sách trang</a> 
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="?mod=blog&action=add_post" title="">Thêm mới</a> 
                                    </li>
                                    <li>
                                        <a href="?mod=blog&action=list_post" title="">Danh sách bài viết</a> 
                                    </li>
                                    <li>
                                        <a href="?mod=blog&action=list_cat" title="">Danh mục bài viết</a> 
                                    </li>
                                </ul>
                            </li>
                            <li>
