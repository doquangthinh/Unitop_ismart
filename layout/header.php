                    ...
                    <div class="wp-inner">
                        ...
                        <div id="main-menu-wp" class="fl-right">
                            <ul id="main-menu" class="clearfix">
                                ...
                                <li>
                                    <a href="index.php?mod=products&action=show_product" title="">Sản phẩm</a>
                                </li>
                                <li>
                                    <a href="index.php?mod=blog&action=index" title="">Blog</a>
                                </li>
                                <li>
                                    <a href="index.php?mod=page&action=index&id=2" title="">Giới thiệu</a>
                                </li>
                                <li>
                                    <a href="index.php?mod=page&action=index&id=3" title="">Liên hệ</a>
                                </li>
                            </ul>
                        </div>
                    </div>
